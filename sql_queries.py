...
user_table_create = ("""CREATE TABLE IF NOT EXISTS users(user_id int PRIMARY KEY,first_name varchar,last_name varchar,level varchar,gender varchar);
""")
...
user_table_insert = ("""INSERT INTO users(user_id,first_name,last_name,level,gender)
VALUES(%s,%s,%s,%s,%s)
ON CONFLICT (user_id)
